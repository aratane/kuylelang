                    ...
                    <form class="row g-3" action="{{ route('barang.update', $barang->id_barang) }}" method="POST"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('harga_awal') is-invalid @enderror"
                                name="harga_awal" id="rupiah" value="{{ old('harga_awal', $barang->harga_awal) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" id="position-option" name="id_user" disabled>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_petugas') is-invalid @enderror"
                                name="nama_petugas" value="{{ old('harga_awal', $barang->nama_petugas) }}" disabled
                                readonly>
