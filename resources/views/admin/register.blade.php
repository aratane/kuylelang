      ...
      <div class="auth-cover-wrapper bg-primary-100">
        <div class="auth-cover">
          <div class="title text-center">
            <h1 class="text-primary mb-10">Daftar Akun Admin</h1>
          </div>
    ...
    <div class="col-lg-6">
      <div class="signup-wrapper">
        <div class="form-wrapper">
          ...
          @endforeach
          @endif
          <form method="POST" action="{{ route('adminregister.action') }}">
            @csrf
            <div class="row">
              <div class="col-12">
                <div class="input-style-1">
                  <label>Nama Lengkap</label>
                  <input name="nama_petugas" type="text" value="{{ old('nama_petugas') }}" placeholder="Nama lengkap anda..." />
                </div>
              </div>
              <!-- end col -->
              <div class="col-12">
